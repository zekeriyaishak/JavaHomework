	 ...
	 public boolean isValidEmail(String email) {
	    ...
	    public boolean isValid(User user) {
	        ...
	        if(!isValidString(user.getFirstName())){
	            System.out.println("Yanlýþ isim girdiniz => en az 2 karakter girmelisiniz ve sayý içermemeli!");
	            return false;

	        }
	        if(!isValidString(user.getLastName())){
	            System.out.println("Yanlýþ soyadý girdiniz => en az 2 karakter girmelisiniz ve sayý içermemeli!");
	            return false;

	        }
	        if(!isValidPassword(user.getPassword())){
	            System.out.println("Yanlýþ parola girdiniz => parolanýz için en az 6 karakter girmelisiniz!");
	            return false;
